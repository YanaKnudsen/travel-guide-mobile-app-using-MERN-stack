    ...
    constructor() {
       ...
       // makeAutoObservable(this);
        makePersistable(this, {
            name: 'SampleStore',
            properties: ["hasLocationPermission","isLogined","myLocation","modalIsShown"],
...
export const AppDataStoreStoreContext = React.createContext(store);
export const useAppDataStore = () => React.useContext(AppDataStoreStoreContext)